...
$(() => {
    ...
    $('.navbar-nav .dropdown-item a').on('click', () => {
        $('.navbar-collapse').removeClass('show')
    })

    // Close mobile menu "on click"
    $(() => {
        const navMain = $('.scroll-init')
    ...
    $(document).ready(() => {
        ...
        owl.on('changed.owl.carousel', (event) => {
            ...
            $('.owl-item').not('.cloned').eq(item).find('h6')
.addClass('animated fadeInUp')
            $('.owl-item').not('.cloned').eq(item).find('h1')
.addClass('animated fadeInUp')
            $('.owl-item').not('.cloned').eq(item).find('h2')
.addClass('animated fadeInUp')
            $('.owl-item').not('.cloned').eq(item).find('h5')
.addClass('animated fadeInUp')
            $('.owl-item').not('.cloned').eq(item).find('p')
.addClass('animated fadeInUp')
            $('.owl-item').not('.cloned').eq(item).find('.car-features')
.addClass('animated fadeInRight')
            $('.owl-item').not('.cloned').eq(item).find('.button-1')
.addClass('animated fadeInUp')
            $('.owl-item').not('.cloned').eq(item).find('.button-2')
.addClass('animated fadeInUp')
        })
    })
    ...
    jQuery('.progress-wrap').on('click', (event) => {
